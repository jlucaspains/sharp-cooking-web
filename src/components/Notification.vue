<template>
    <NotificationGroup group="success">
        <div class="fixed inset-0 flex items-start justify-end p-6 px-4 py-8 pointer-events-none">
            <div class="w-full max-w-sm">
                <Notification v-slot="{ notifications }" enter="transform ease-out duration-300 transition"
                    ...
                    <div class="flex w-full max-w-sm mx-auto mt-4 overflow-hidden bg-white dark:bg-theme-secondary-gray rounded-lg shadow-md"
                    ...
                    <div class="flex w-full max-w-sm mx-auto mt-4 overflow-hidden bg-white dark:bg-theme-secondary-gray rounded-lg shadow-md"
                        ...
                        <div class="px-4 py-2 -mx-3">
                            <div class="mx-3">
                                ...
                                <p class="text-sm text-gray-600 dark:bg-theme-secondary-gray">{{ notification.text }}</p>
                            </div>
                        </div>
                    </div>
                </Notification>
